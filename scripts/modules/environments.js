/* ==========================================================================
   ...
   The dropdown-trigger path below (for an entry with a "links" array —
   more than one destination, e.g. a Dev Link with Public/Office/Secure
   options) is commented out: Dev Link now points directly at one secure
   link, so every entry renders as a plain link. Uncomment along with the
   matching block in cards.js and the dropdown.css import in main.css to
   bring the multi-destination dropdown back.
   ========================================================================== */
